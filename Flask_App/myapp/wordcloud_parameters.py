...
def worldcloud_generator(messages,background_color='black',max_words=200):    
    """
    Parameters
    ----------- 
        messages: a Pandas Series containg text.
    ...
    messages = messages.apply(lambda x: x.translate( str.maketrans('', '', string.punctuation) ) ) 
